...
app.get('/catalog/urls',(_q,res)=>res.type('html').send('<html><body><h1>Homestro URLs</h1><ul>'+catalogState.candidates.map(x=>'<li><a href="'+x.url+'">'+x.url+'</a></li>').join('')+'</ul></body></html>'));
