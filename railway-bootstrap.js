...
const RAW='https://raw.githubusercontent.com/homestro/homestro-ai-api/main/patch-json-output.js';
...
(async()=>{
 ...
 fs.writeFileSync('patch-json-output.js',patch);
 console.log('HOMESTRO JSON PATCH FETCHED '+patch.length);
 require('./patch-autopilot.js');
 require('./patch-cost-rules.js');
 require('./patch-shopify-auth.js');
 require('./patch-json-output.js');
